...
defeasibleRulesList.append(DefeasibleRule(l1,l2))
...
defeasibleRulesList.append(DefeasibleRule(r1,l4))
...
defeasibleRulesList.append(DefeasibleRule(r2,l4))
...
# l3 = Literal(stringRepresentation='Cannot make a request')
defeasibleRulesList.append(DefeasibleRule(r3,l4))
...
# l3 = Literal(stringRepresentation='Cannot make a request')
defeasibleRulesList.append(DefeasibleRule(r4,l4))
...
defeasibleRulesList.append(DefeasibleRule(r5,l9))
...
defeasibleRulesList.append(DefeasibleRule(r9, l9))
...
defeasibleRulesList.append(DefeasibleRule(r10,l15))
...
defeasibleRulesList.append(DefeasibleRule(r11, l16))

# Rule 13
r12 = Rule(Rule(l2, Operator.AND, l14), Operator.AND, l12)
defeasibleRulesList.append(DefeasibleRule(r12, l16))

# Rule 14
r13 = Rule(Rule(l2, Operator.AND, l14), Operator.AND, l13)
defeasibleRulesList.append(DefeasibleRule(r13, l16))

# Rule 15
r14 = Rule(Rule(l2, Operator.AND, l14), Operator.AND, l7)
defeasibleRulesList.append(DefeasibleRule(r14, l15))
...
defeasibleRulesList.append(DefeasibleRule(r15, l18))
...
defeasibleRulesList.append(DefeasibleRule(r16, l19))

# Rule 18
r17 = Rule(Rule(l2, Operator.AND, l17), Operator.AND, l12)
defeasibleRulesList.append(DefeasibleRule(r17, l19))

# Rule 19
r18 = Rule (Rule(l2, Operator.AND, l17), Operator.AND, l13)
defeasibleRulesList.append(DefeasibleRule(r18, l19))

# Rule 20
r19 = Rule(Rule(l2, Operator.AND, l17), Operator.AND, l7)
defeasibleRulesList.append(DefeasibleRule(r19, l18))
...
defeasibleRulesList.append(DefeasibleRule(l8, l24))

# Rule 25
l25 = Literal(stringRepresentation='power to Reject Request Change Working Hours')
defeasibleRulesList.append(DefeasibleRule(r20, l25))
...
defeasibleRulesList.append(DefeasibleRule(r21, l30))

# Rule 30
l31 = Literal(stringRepresentation='POWER to Change Request Change Working Times')
defeasibleRulesList.append(DefeasibleRule(r21, l31))
...
defeasibleRulesList.append(DefeasibleRule(l18, l32))   
...
defeasibleRulesList.append(DefeasibleRule(r22, l34))
...
defeasibleRulesList.append(DefeasibleRule(r23, l36))
...
defeasibleRulesList.append(DefeasibleRule(r24, l38))
...
defeasibleRulesList.append(DefeasibleRule(r25, l39))
...
defeasibleRulesList.append(DefeasibleRule(r26, l41))
...
defeasibleRulesList.append(DefeasibleRule(r27, l42))
...
defeasibleRulesList.append(DefeasibleRule(r28, l44))
...
defeasibleRulesList.append(DefeasibleRule(r29, l45))
...
defeasibleRulesList.append(DefeasibleRule(r30, l47))
...
defeasibleRulesList.append(DefeasibleRule(r31, l48))
...
defeasibleRulesList.append(DefeasibleRule(r32, l50))
...
defeasibleRulesList.append(DefeasibleRule(r33, l51))
...
defeasibleRulesList.append(DefeasibleRule(r34, l34))

# Rule 45
r34 = Rule(Rule(l25, Operator.AND, l52), Operator.AND, l38)
defeasibleRulesList.append(DefeasibleRule(r34, l36))
...
defeasibleRulesList.append(DefeasibleRule(r35, l34))

# Rule 47
r36 = Rule(Rule(Rule(l9, Operator.AND, l7), Operator.AND, l53), Operator.AND, l38)
defeasibleRulesList.append(DefeasibleRule(r36, l36))

# Rule 48
r37 = Rule(l15, Operator.AND, l52)
defeasibleRulesList.append(DefeasibleRule(r37, l41))

# Rule 49
r38 = Rule(Rule(l15, Operator.AND, l52), Operator.AND, l44)
defeasibleRulesList.append(DefeasibleRule(r38, l42))

# Rule 50
# l7 = Literal(stringRepresentation='Immunity unforseen circumstances')
r39 = Rule(Rule(l15, Operator.AND, l7), Operator.AND, l53)
defeasibleRulesList.append(DefeasibleRule(r39, l41))

# Rule 51
r40 = Rule(Rule(Rule(l15, Operator.AND, l7), Operator.AND, l53), Operator.AND, l44)
defeasibleRulesList.append(DefeasibleRule(r40, l42))

# Rule 52
r41 = Rule(l18, Operator.AND, l52)
defeasibleRulesList.append(DefeasibleRule(r41, l47))

# Rule 53 
r42 = Rule(Rule(l18, Operator.AND, l52), Operator.AND, l50)
defeasibleRulesList.append(DefeasibleRule(r42, l48))

# Rule 54
# l7 = Literal(stringRepresentation='Immunity unforseen circumstances')
r43 = Rule(Rule(l18, Operator.AND, l7), Operator.AND, l53)
defeasibleRulesList.append(DefeasibleRule(r43, l47))

# Rule 55
r44 = Rule(Rule(Rule(l18, Operator.AND, l7), Operator.AND, l53), Operator.AND, l50)
defeasibleRulesList.append(DefeasibleRule(r44, l48))
